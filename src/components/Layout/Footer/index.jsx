...
<footer className="fixed bottom-0 left-0 z-20 w-full p-4 bg-dark border-t border-gray-200 shadow flex items-center justify-between p-4 bg-gray-800 border-gray-600">
